...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'submit_request') {
    ...
    if (isset($_FILES['valid_id_front']) && $_FILES['valid_id_front']['error'] === UPLOAD_ERR_OK) {
        ...
        $file_extension = pathinfo($_FILES['valid_id_front']['name'], PATHINFO_EXTENSION);
    ...
    if (!isset($error_message) && isset($_FILES['valid_id_back']) && $_FILES['valid_id_back']['error'] === UPLOAD_ERR_OK) {
        $file_extension = pathinfo($_FILES['valid_id_back']['name'], PATHINFO_EXTENSION);
    ...
    if (!isset($error_message)) {
        ...
        $stmt = $conn->prepare("INSERT INTO client_request_form (request_id, client_id, full_name, address, gender, valid_id_front_path, valid_id_front_filename, valid_id_back_path, valid_id_back_filename, privacy_consent) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        $privacy_consent_value = 1;
        $stmt->bind_param("sisssssssi", $request_id, $client_id, $full_name, $address, $gender, $valid_id_front_path, $valid_id_front_filename, $valid_id_back_path, $valid_id_back_filename, $privacy_consent_value);
...
<body>
                    ...
                    <form method="POST" enctype="multipart/form-data" class="request-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="file-upload-container">
                                <input type="file" id="valid_id_front" name="valid_id_front" accept="image/*,.pdf" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="file-upload-container">
                                <input type="file" id="valid_id_back" name="valid_id_back" accept="image/*,.pdf" required>
    ...
    <style>
        ...
        /* Standard Design - Match other pages */
        body {
    ...
    <script>
        ...
        // File upload preview for front ID
        ...
        // File upload preview for back ID
