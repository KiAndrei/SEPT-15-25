...
<div style="font-size:11pt; line-height:1.2;">
    ...
    <div style="text-align:justify; margin-bottom:15px;">
        ...
        single/married, &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; and &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; with &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; residence &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; and &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; postal &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;address &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;at
        __________________________________________________________________________, after 
        ...
        <div style="margin-left: 60px; margin-right: 60px;">
            <table style="width:100%; border-collapse:collapse; margin-bottom:2px;">
                <tr>
                    ...
                    <td style="width:7%; text-align:center; border:none;"><b>Age</b></td>
                </tr>
            </table>
        ...
        <br>
        <div style="margin-left: 40px;">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. That &nbsp; I &nbsp; am &nbsp; solely &nbsp; taking  &nbsp; care &nbsp; and providing for my said child's &nbsp; /&nbsp; children's needs<br> 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;and everything indispensable for his/her/their wellbeing for ____________ year/s now<br> 
        ...
        <br>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<table style="border-collapse:collapse;">
                <tr>
                    <td style="width:22px; vertical-align:top; padding-top:2px;"><div style="width:12px; height:12px; border:1px solid #000;"></div></td>
                ...
                <tr>
                    <td style="width:22px; vertical-align:top; padding-top:2px;"><div style="width:12px; height:12px; border:1px solid #000;"></div></td>
                    <td>(other reason please state)_________ <span style="display:inline-block; border-bottom:1px solid #000; width: 220px;"></span>;</td>
                </tr>
            </table>
        ...
        <div style="margin-left: 40px;">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<table style="border-collapse:collapse;">
                ...
                <tr>
                    <td style="width:22px; vertical-align:top; padding-top:2px;"><div style="width:12px; height:12px; border:1px solid #000;"></div></td>
                    <td>
Self-employed and earning Php ______________ per month, from
                        <div>my job as _________________<span style="display:inline-block; border-bottom:1px solid #000; width: 160px;"></span>;</div>
                    </td>
                </tr>
                <tr>
                    <td style="width:22px; vertical-align:top; padding-top:2px;"><div style="width:12px; height:12px; border:1px solid #000;"></div></td>
                    <td>Un-employed and dependent upon______________________</td>
                </tr>
            </table>
        
        
        <div style="margin-left: 40px;">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5. That I am executing this affidavit, to affirm the truth and veracity of the foregoing<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; statements and be use for whatever legal purpose it may serve.
        </div>
    </div>
    ...
    <div style="text-align:justify; margin-bottom:15px;">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SUBSCRIBED AND SWORN to before me this ____________________________ at the City of Cabuyao, Laguna, affiant personally appeared and exhibiting to me his/her _______________________ with ID No. _______________________ as competent proof of identity.
    </div>
